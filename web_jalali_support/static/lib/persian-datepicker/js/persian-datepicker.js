...
var Config = {
  ...
  'dayPicker': {
    ...
    'titleFormatter': function titleFormatter(year, month) {
      var titleDate = new pDate([year, month]);
 ...
 */
(function ($) {
    $.fn.pDatepicker = $.fn.pDatepicker = function (options) {
...
var Input = function () {
    ...
    _createClass(Input, [{
        ...
        value: function observe() {
            ...
            //             let newPersainDate = new pDate(newDate);
...
var State = function () {
    ...
    _createClass(State, [{
        ...
        value: function _updateSelectedUnix() {
            this.selected.dateObject = new pDate([this.selected.year, this.selected.month, this.selected.date, this.view.hour, this.view.minute, this.view.second]);
        ...
        value: function _setViewDateTimeUnix() {
            this.view.dateObject = new pDate([this.view.year, this.view.month, this.view.date, this.view.hour, this.view.minute, this.view.second]);
